...
public class CookieUtils {
	 ...
	 */
	public static void addAuthnCookie(Request request, String identifier, String cloudServiceName) {

		request.getCookies().clear();
		CookieSetting cookieSetting = createAuthnCookieSetting(
				COOKIE_DEFAULT_IDTYPE, identifier, generateCloudServiceNameProperties(cloudServiceName));
		request.getCookies().add(cookieSetting);
	}
