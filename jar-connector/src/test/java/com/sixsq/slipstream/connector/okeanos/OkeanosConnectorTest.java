...
public class OkeanosConnectorTest {
    ...
    public void ensureConnectorFactoryFindsConnectorWithName() throws Exception {
        ...
        SystemConfigurationParametersFactoryBase factory = new OkeanosSystemConfigurationParametersFactory(
                CLOUD_SERVICE_NAME);
    ...
    public void ensureConnectorFactoryFindsConnectorWithClassName() throws Exception {
        ...
        String configConnectorName = OkeanosConnector.class.getCanonicalName();
        String cloudServiceName = CLOUD_SERVICE_NAME;
        SystemConfigurationParametersFactoryBase factory = new OkeanosSystemConfigurationParametersFactory(
                CLOUD_SERVICE_NAME);
