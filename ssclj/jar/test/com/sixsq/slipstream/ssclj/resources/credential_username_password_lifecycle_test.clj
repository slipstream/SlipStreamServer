(ns com.sixsq.slipstream.ssclj.resources.credential-username-password-lifecycle-test
  (:require
...
(deftest lifecycle
  (let [href (str ct/resource-url "/" upc/credential-type)
        template-url (str p/service-context ct/resource-url "/" upc/credential-type)
