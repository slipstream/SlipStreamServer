...
public class CookieTest extends ResourceTestBase {
	...
	private void createPublicKeyFileAndSetConnector() throws IOException, ValidationException {
		Map<String, ServiceConfigurationParameter> params = new HashMap<String, ServiceConfigurationParameter>(1);
		...
		param = new ServiceConfigurationParameter(paramName,
				cloudServiceName + ":com.sixsq.slipstream.connector.local.LocalConnector," +
				cloudServiceNameB + ":com.sixsq.slipstream.connector.local.LocalConnector");
		params.put(paramName, param);
