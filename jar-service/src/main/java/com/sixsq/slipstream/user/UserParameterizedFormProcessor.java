...
public abstract class UserParameterizedFormProcessor {

	private User parametrized;
	private Map<String, UserParameter> existingParameters;
	private User user;
	private Form form;
	...
	public UserParameterizedFormProcessor(User user) {
		this.user = user;
	}
	...
	public User getParametrized() {
		return parametrized;
	}

	protected void setParametrized(User parametrized) {
		this.parametrized = parametrized;
	}

	abstract protected User getOrCreateParameterized(String name)
	...
	protected void parseFormParameters() throws BadlyFormedElementException,
		...
		// - parameter--[id]--value
		// ...
		existingParameters = new ConcurrentHashMap<String, UserParameter>
				(getParametrized().getParameters());
	...
	private String parseValue(String value, UserParameter parameter) {
		String parsed = value;
	...
	private boolean shouldSetValue(UserParameter parameter, String value) {
		return !parameter.isReadonly() || user.isSuper();
	}

	protected abstract UserParameter createParameter(String name, String value,
