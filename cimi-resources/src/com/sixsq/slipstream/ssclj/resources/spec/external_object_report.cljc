...
(s/def :cimi.external-object-template.report/objectStoreCred :cimi.common/resource-link)
(s/def :cimi.external-object-template.report/bucketName :cimi.core/nonblank-string)
...
(s/def :cimi/external-object-template.report
    (su/only-keys-maps eot/resource-keys-spec
                       {:req-un [:cimi.external-object-template.report/runUUID
                                 ...
                                 :cimi.external-object-template.report/bucketName
                                 :cimi.external-object-template.report/objectStoreCred]}))
