(ns com.sixsq.slipstream.ssclj.resources.module-component
  (:require
...
(def ^:const resource-name "ModuleComponent")
...
(defn initialize
  []
  (std-crud/initialize resource-url ::module-component/module-component))
